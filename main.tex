...
\newcommand{\SIi}[2]{\SI[round-precision=0]{#1}{#2}}
\usepackage{multirow}
...
\hypersetup{
    ...
    filecolor=black,
    urlcolor=black,
    pdftitle={Refining the I2C proposal for WebAssembly System Interface},
    pdfauthor={Robin Verbeelen}
}
...
\include{chapters/7_1_intro.tex}
\pagestyle{fancy}
\include{chapters/7_2_lit.tex}
\include{chapters/7_3_impl.tex}
\include{chapters/7_4_eval.tex}
\pagestyle{numberless} 
\include{chapters/8_conclusion.tex}
\include{chapters/9_future-work.tex}
\include{chapters/10_ethical-reflection.tex}
\include{chapters/11_bibliography.tex}
